#no tail
#position, mapa, objects, obstaculos seran los entrenadores pokemon, cuando se coma se ira a un combate pokemon y cuando se hayan vencido se acaba el juego
